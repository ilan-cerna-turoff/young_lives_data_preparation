...
####      N. NOTES      ####
#--------------------------#
# This script is meant to merge all intermediate cvd_ych files to produce final
# cleaned data files by country. All rounds merged into one clean data file.
#
# This script relies on the following file(s) as inputs:
#   * All .rds files inside data/intermediate/cvd_ych
#
# This script generates the following file(s) as outputs:
#   * data/final/cvd_ych/et.rds
#   * data/final/cvd_ych/in.rds
#   * data/final/cvd_ych/pe.rds
#   * data/final/cvd_ych/vt.rds
#
# Warnings: None 
