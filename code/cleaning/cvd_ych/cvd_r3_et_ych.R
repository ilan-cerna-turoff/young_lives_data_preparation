# File: Ethiopia covid survey with younger children round 3
# Date: 13/04/2022
...
df1 <- df1 %>%
  ...
  replace_na(list(ened02cov3 = "missing", cureducov3 = "missing", hep_group_tc = "missing", typesite_tc = "missing")) %>%
